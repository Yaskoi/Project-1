...
table1 = stargazer(reg_wage_a.MCO, reg_wage_a.TSLS,reg_wage_b.MCO, reg_wage_b.TSLS,
...
table2 = stargazer(reg_wage_c.MCO, reg_wage_c.TSLS,reg_wage_d.MCO, reg_wage_d.TSLS,
                    dep.var.caption="",dep.var.labels="",
                    omit.table.layout = "n", star.cutoffs = NA,keep.stat=c("rsq","n"),
                    no.space=TRUE, digits=4,
                    header=FALSE,
